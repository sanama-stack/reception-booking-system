...
| **Measured** | 2026-09-17 — [the reopening comment](https://github.com/sanama-stack/reception-booking-system/issues/40#issuecomment-5625346280) and §8.5 of [the fifth candidate's record](experiments/2026-09-17-17-reschedule-searches-the-requested-date.md). **And 2026-09-22, the first arm ever targeted at this sub-mode**: §9 of [the scenario record](experiments/2026-09-22-40-mechanism-2-scenario.md) — two arms, **0 of 95** trials that reached the decision point refused, CI [0%, 3.81%]. Arm B staged the wrong-day search deliberately and got it in **50 of 50** trials; the defect fired in none of them |
