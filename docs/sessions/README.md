...
| [2026-09-09](./2026-09-09-phase-07-notifications.md) | Phase 07 — Notifications. **Phase 07 complete.** 674 tests. The outbox, the poller and the Manage Link; a documented index corrected because it would have made a required email impossible. |
